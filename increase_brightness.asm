...
.data
    ...
    input_file:  .asciiz "D:\arch_ass\house_64_in_ascii_crlf.ppm"     #input file name
    output_file:   .asciiz "D:\arch_ass\house_64_in_ascii_crlf_result001.ppm"    # New output file name
    image_width:    .space 47434             # image_width for reading and writing 
